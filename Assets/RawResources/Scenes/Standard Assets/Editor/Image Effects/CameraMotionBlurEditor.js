...
{	
  ...
  var mPreview : SerializedProperty;
  var mPreviewScale : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    mPreview = serObj.FindProperty ("mPreview");
    mPreviewScale = serObj.FindProperty ("mPreviewScale");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (mPreview, new GUIContent("mPreview"));
    if (mPreview.boolValue)
      EditorGUILayout.PropertyField (mPreviewScale, new GUIContent(""));    
